...
const QuestionCard = ({
  ...
  return (
    <div className="flex flex-col bg-white border p-5 rounded-xl min-h-[20rem]">
      {/* Card Title */}
      <div className="flex items-start justify-between">
        ...
        <button className="text-xl p-2 rounded-md hover:bg-accent opacity-80 hover:opacity-100 duration-200">
          <BsThreeDots />
        </button>
      </div>
