...
const Input = () => (
  <div className="w-full border flex justify-between items-center h-14 py-1.5 px-3 rounded-xl border-border hover:opacity-80 duration-100 shadow-md bg-white cursor-pointer">
